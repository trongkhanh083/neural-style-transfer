    ...
    for preds, losses, i, epoch in optimize(*args, **kwargs):
        ...
        if options.test:
            ...
            if not options.slow:
                ...
                inference.ffwd_to_img(options.test,preds_path,
                                     options.checkpoint_dir)
            else:
                save_img(preds_path, options.test)
    ckpt_dir = options.checkpoint_dir
    cmd_text = 'python inference.py --checkpoint %s ...' % ckpt_dir
